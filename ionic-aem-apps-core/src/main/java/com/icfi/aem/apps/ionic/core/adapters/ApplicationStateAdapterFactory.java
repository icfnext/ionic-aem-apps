...
import com.icfi.aem.apps.ionic.core.predicates.application.root.ApplicationStatePagePredicate;
...
@Properties({
        ...
        @Property(name = SlingConstants.PROPERTY_ADAPTER_CLASSES, value = {
                "com.icfi.aem.apps.ionic.api.models.application.state.ApplicationState"
        })
})
